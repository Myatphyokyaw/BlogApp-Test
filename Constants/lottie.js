const startOne = require('../Assests/Lotties/start1.json')
const startTwo = require('../Assests/Lotties/start2.json')
const startThree = require('../Assests/Lotties/start3.json')
const startFour = require('../Assests/Lotties/start4.json')
